...
int init_filter( const char *filters_desc ) {
	...
	ret = av_dict_set( &option, "sample_fmts", av_get_sample_fmt_name( AV_SAMPLE_FMT_FLTP ), 0 );
...
int main( int argc, char **argv ) {
	...
	filters_desc_arg.append( "[0:a]aresample=44100,aformat=sample_fmts=fltp" );
	filters_desc_arg.append( ",asetnsamples=n=1152" );
	filters_desc_arg.append( "[a1]" );
	filters_desc_arg.append( ";[1:a]aresample=44100,aformat=sample_fmts=fltp,volume=1" );
	filters_desc_arg.append( ",asetnsamples=n=1152" );
	filters_desc_arg.append( "[a2]" );
	filters_desc_arg.append( ";[a1][a2]amix,asetnsamples=n=1152" );
