...
void get_adts_header( AVCodecContext *codec_ctx, char *adts_header, int aac_length ) {
	...
	switch( codec_ctx->sample_rate ) {
		case 96000 : freq_index = 0;
			break;
		case 88200 : freq_index = 1;
			break;
		case 64000 : freq_index = 2;
			break;
		case 48000 : freq_index = 3;
			break;
		case 44100 : freq_index = 4;
			break;
		case 32000 : freq_index = 5;
			break;
		case 24000 : freq_index = 6;
			break;
		case 22050 : freq_index = 7;
			break;
		case 16000 : freq_index = 8;
			break;
		case 12000 : freq_index = 9;
			break;
		case 11025 : freq_index = 10;
			break;
		case 8000 : freq_index = 11;
			break;
		case 7350 : freq_index = 12;
			break;
		default : freq_index = 4;
			break;
	}
...
int init_audio_encoder( int nb_channels ) {
	...
	audio_encode_ctx->profile = AV_PROFILE_AAC_LOW; // AAC规格
...
int main( int argc, char **argv ) {
	...
	if( nb_channels == 2 ) { // 双声道（立体声）
		...
		data_size = av_samples_get_buffer_size(
			NULL,
			audio_encode_ctx->ch_layout.nb_channels, audio_encode_ctx->frame_size, audio_encode_ctx->sample_fmt, 1 );
