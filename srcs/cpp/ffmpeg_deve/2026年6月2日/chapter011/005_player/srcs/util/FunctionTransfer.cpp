...
FunctionTransfer::FunctionTransfer( QObject *parent ) :
	...
	connect( this, &FunctionTransfer::comming, this, &FunctionTransfer::slotExec, Qt::BlockingQueuedConnection );
	connect( this, &FunctionTransfer::comming_noBlock, this, &FunctionTransfer::slotExec, Qt::BlockingQueuedConnection );
}
