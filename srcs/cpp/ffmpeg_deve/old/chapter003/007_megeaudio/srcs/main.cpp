...
int main( int argc, char *argv[ ], char *envp[ ] ) {
	const char *video_name = cmake_property_SOURCE_DIR "/../../FFmpeg resources/fuzhou.mp4";
	const char *audio_name = cmake_property_SOURCE_DIR "/../../FFmpeg resources/fuzhous.aac";
